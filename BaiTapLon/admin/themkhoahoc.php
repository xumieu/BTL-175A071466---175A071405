    ...
    <div class="content-right">
      <div id="page-wrapper">
        <form method="post" action="">
          <h3 id="result"></h3>
          <h2 style="color: #6495ED">Thêm Mới Khóa Học</h2>
        ...
        if (isset($_POST["submit"])) {
          ...
          $sql = "INSERT INTO tbl_khoahoc ( id, tenkhoahoc, hinhanh,  ngaykhaigiang, thoiluong, thoigian, lichhoc ) VALUES ( '','$tenkhoahoc', '$hinhanh', '$ngaykhaigiang', '$thoiluong', '$thoigian', '$lichhoc' )";
          $result = mysqli_query($conn, $sql);

           echo "<p>Khóa học đã thêm thành công</p>";
